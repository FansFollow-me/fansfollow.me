	...
	protected function uploadVideo($video)
				{
                    ...
                    $result = shell_exec('sh /home/fansfollow/public_html/spritevideo -i '.$localFile.' -o /home/fansfollow/public_html/public/uploads/stories -p /home/fansfollow/public_html/public/uploads/stories/'.$img_name.'.jpeg');
		  ...
		  $main_path = config('path.stories');
                    
                    if($videoPoster){
                        $this->moveFileStorage($videoPoster, $main_path);
                    }
					// Move file to Storage
				//	if ($this->settings->video_encoding == 'off') {
						$this->moveFileStorage($video, $main_path);
				//	}
				}
	/**
	 * Move file to Storage
