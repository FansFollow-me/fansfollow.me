	      ...
	      */
			protected function uploadVideo($video)
			{
                ...
                /*My Changes*/
                    ...
                    $result = shell_exec('sh /home/fansfollow/public_html/spritevideo -i '.$localFile.' -o /home/fansfollow/public_html/public/uploads/updates/images -p /home/fansfollow/public_html/public/uploads/updates/images/'.$img_name.'.jpeg');
				...
				//'thumimge' => $img_name.'.jpeg',
					...
					/*$path = config('path.videos');
					if($videoPoster){
                        $this->moveFileStorage($videoPoster, $path);
                    }*/
					if ($this->settings->video_encoding == 'off') {
