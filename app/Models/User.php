...
class User extends Authenticatable implements HasLocalePreference
{
    ...
    /*My Changes*/
    public function commentsShop() {
		return $this->hasMany(Comments::class);
	}
	public function likesShop() {
		return $this->hasMany(Like::class);
	}
	/*My Changes en*/
     ...
     */
      ...
      */
      ...
      public function replies()
      {
        ...
        // My changes
      public function mySubscriptionsUser($id)
    {
          return $this->hasManyThrough(
                Subscriptions::class,
                Plans::class,
     ...
     /*My Changes*/
      public function likesCountPro()
      {
        return $this->hasManyThrough(Like::class, Products::class, 'user_id', 'updates_id')->where('likes.status', '=', '1')->count();
      }
     /*My Changes*/
      public function checkBlock($user)
      {
        return BlockedUsers::Where('user_id',$this->id)
          ->whereBlockedBy($user)
          ->first();
      }
      ...
      {
        return BlockedUsers::whereUserId($user)
          ->whereBlockedBy($this->id)
          ->first();
      }
      ...
      /* Fix: point Laravel MustVerifyEmail at the real verify route
         (default referenced non-existent 'verification.verify' route name) */
      public function verificationUrl()
      {
          return url('/verify/account/'.$this->confirmation_code);
      }
