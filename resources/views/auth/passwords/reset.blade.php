...
@php($authAction = $isStaging ? '/auth/password/reset' : url('password/reset'))
    ...
    <div class="container">
      <div class="auth-stage">
        ...
        <div class="auth-hero-copy">
          ...
          <h1 class="auth-heading">{{ trans('auth.reset_password') }}</h1>
          <p class="auth-subheading">{{ trans('auth.reset_pass_subtitle') }}</p>
        </div>
        ...
        <div class="auth-card">
          <div class="auth-card__body">
            ...
            <form method="POST" action="{{ $authAction }}" class="auth-form">
              ...
              <button type="submit" class="btn btn-primary w-100">{{ trans('auth.reset_password') }}</button>
            </form>
