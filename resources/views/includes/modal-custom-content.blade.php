				...
				<div class="card bg-white shadow border-0">
					...
					<div class="card-body px-lg-5 py-lg-5 position-relative">
						...
						<div class="mb-4 position-relative">
						    <!--My Changes my_lang.detail-->
							 <strong>{{ $sale->products() ? $sale->products()->type == 'physical' ? __('general.shipping_information') : __('my_lang.detail') : ''}}</strong>
                        ...
                        <!--My Changes -->
						@if ($sale->products() && $sale->products()->type == 'physical')
