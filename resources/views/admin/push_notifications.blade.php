...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.push_notifications') }}</h5>
  <h2 class="mb-1">Push notifications</h2>
  <p class="text-muted mb-0">Configure push notifications from the redesigned admin shell.</p>
</div>
@endif
