...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.payment_settings') }}</h5>
  <h2 class="mb-1">{{ trans('admin.currency_code') }}</h2>
  <p class="text-muted mb-0">Adjust platform currency, fees, and referral defaults from the redesigned admin shell.</p>
</div>
@endif
