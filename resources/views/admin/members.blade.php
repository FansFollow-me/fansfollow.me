...
<div class="mb-4">
  ...
  <h2 class="mb-1">Creator members</h2>
  <p class="text-muted mb-0">Search, review, and manage creator accounts from the redesigned moderation shell.</p>
</div>
@endif
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.members') }}</h5>
  <h2 class="mb-1">{{ __('admin.members') }} ({{$data->total()}})</h2>
  <p class="text-muted mb-0">Search creators, review account status, and manage permissions from the redesigned admin workspace.</p>
</div>
