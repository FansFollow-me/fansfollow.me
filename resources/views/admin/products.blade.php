...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.products') }}</h5>
  <h2 class="mb-1">Creator products</h2>
  <p class="text-muted mb-0">Review creator shop products from the redesigned admin shell.</p>
</div>
@endif
