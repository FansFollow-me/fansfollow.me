...
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.pages') }}</h5>
  <h2 class="mb-1">{{ __('admin.pages') }} ({{$data->count()}})</h2>
  <p class="text-muted mb-0">Manage static pages, access rules, and translations from the redesigned admin interface.</p>
</div>
