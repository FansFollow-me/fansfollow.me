...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.verification_requests') }}</h5>
  <h2 class="mb-1">Creator verification</h2>
  <p class="text-muted mb-0">Process verification requests from the redesigned admin moderation shell.</p>
</div>
@endif
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.verification_requests') }}</h5>
  <h2 class="mb-1">{{ __('admin.verification_requests') }} ({{$data->total()}})</h2>
  <p class="text-muted mb-0">Process creator verification requests, documents, and approval actions from the redesigned admin workflow.</p>
</div>
