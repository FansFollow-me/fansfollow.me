...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ trans('general.donations') }}</h5>
  <h2 class="mb-1">Donation records</h2>
  <p class="text-muted mb-0">Review donation activity from the redesigned admin shell.</p>
</div>
@endif
