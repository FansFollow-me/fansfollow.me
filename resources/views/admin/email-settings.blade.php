...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.email_settings') }}</h5>
  <h2 class="mb-1">SMTP and notifications</h2>
  <p class="text-muted mb-0">Configure outbound mail delivery from the redesigned admin shell.</p>
</div>
@endif
