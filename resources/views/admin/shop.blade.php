...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.shop') }}</h5>
  <h2 class="mb-1">Marketplace shop</h2>
  <p class="text-muted mb-0">Manage the storefront configuration from the redesigned admin shell.</p>
</div>
@endif
