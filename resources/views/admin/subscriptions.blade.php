...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.subscriptions') }}</h5>
  <h2 class="mb-1">Subscription members</h2>
  <p class="text-muted mb-0">Review creator subscriptions from the redesigned admin shell.</p>
</div>
@endif
