...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">PayPal settings</h5>
  <h2 class="mb-1">PayPal gateway</h2>
  <p class="text-muted mb-0">Manage PayPal credentials and payout behavior from the redesigned admin shell.</p>
</div>
@endif
