...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.categories') }}</h5>
  <h2 class="mb-1">Content categories</h2>
  <p class="text-muted mb-0">Manage platform categories from the redesigned admin shell.</p>
</div>
@endif
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('general.categories') }}</h5>
  <h2 class="mb-1">{{ __('general.categories') }} ({{$totalCategories}})</h2>
  <p class="text-muted mb-0">Maintain category structure, visibility, and edit actions from the refreshed admin layout.</p>
</div>
