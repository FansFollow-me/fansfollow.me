...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.social_login') }}</h5>
  <h2 class="mb-1">Social login providers</h2>
  <p class="text-muted mb-0">Manage OAuth credentials and login toggles from the redesigned admin shell.</p>
</div>
@endif
