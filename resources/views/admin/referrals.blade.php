...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.referrals') }}</h5>
  <h2 class="mb-1">Referral activity</h2>
  <p class="text-muted mb-0">Track referral earnings and activity from the redesigned finance dashboard.</p>
</div>
@endif
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('general.referrals') }}</h5>
  <h2 class="mb-1">{{ __('general.referrals') }} ({{$data->total()}})</h2>
  <p class="text-muted mb-0">Track referral activity, earnings, and attribution from the redesigned admin workspace.</p>
</div>
