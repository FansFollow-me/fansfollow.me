...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.languages') }}</h5>
  <h2 class="mb-1">Add language</h2>
  <p class="text-muted mb-0">Create a new platform language from the redesigned admin shell.</p>
</div>
@endif
