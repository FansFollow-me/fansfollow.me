...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.theme') }}</h5>
  <h2 class="mb-1">{{ __('general.home_style') }}</h2>
  <p class="text-muted mb-0">Adjust the homepage and branding assets from the redesigned admin shell.</p>
</div>
@endif
