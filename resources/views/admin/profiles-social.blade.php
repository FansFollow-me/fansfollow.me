...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.profiles_social') }}</h5>
  <h2 class="mb-1">Social profile links</h2>
  <p class="text-muted mb-0">Update social profile links displayed across the platform from the redesigned admin shell.</p>
</div>
@endif
