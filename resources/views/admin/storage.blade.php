...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.storage') }}</h5>
  <h2 class="mb-1">Cloud storage</h2>
  <p class="text-muted mb-0">Configure file storage and CDN settings from the redesigned admin shell.</p>
</div>
@endif
