...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">Bank settings</h5>
  <h2 class="mb-1">Manual payouts</h2>
  <p class="text-muted mb-0">Configure bank payout details from the redesigned admin shell.</p>
</div>
@endif
