...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.stories') }}</h5>
  <h2 class="mb-1">Story backgrounds</h2>
  <p class="text-muted mb-0">Manage story background assets from the redesigned admin shell.</p>
</div>
@endif
