...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.reports') }}</h5>
  <h2 class="mb-1">Report queue</h2>
  <p class="text-muted mb-0">Review creator and content reports from the redesigned moderation workspace.</p>
</div>
@endif
