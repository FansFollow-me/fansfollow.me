...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.live_streaming') }}</h5>
  <h2 class="mb-1">Live streaming settings</h2>
  <p class="text-muted mb-0">Configure broadcast infrastructure and limits from the redesigned admin shell.</p>
</div>
@endif
