...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.tax_rates') }}</h5>
  <h2 class="mb-1">Edit tax rate</h2>
  <p class="text-muted mb-0">Update an existing tax rule from the redesigned admin shell.</p>
</div>
@endif
