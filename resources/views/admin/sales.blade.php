...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.sales') }}</h5>
  <h2 class="mb-1">Product sales</h2>
  <p class="text-muted mb-0">Review creator shop sales from the redesigned finance workspace.</p>
</div>
@endif
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('general.sales') }}</h5>
  <h2 class="mb-1">{{ __('general.sales') }} ({{$sales->total()}})</h2>
  <p class="text-muted mb-0">Review product sales, fulfillment outcomes, and seller activity from the updated admin shell.</p>
</div>
