...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.posts') }}</h5>
  <h2 class="mb-1">Post moderation</h2>
  <p class="text-muted mb-0">Review creator submissions from the redesigned content moderation workspace.</p>
</div>
@endif
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('general.posts') }}</h5>
  <h2 class="mb-1">{{ __('general.posts') }} ({{$data->total()}})</h2>
  <p class="text-muted mb-0">Review creator submissions, moderation status, and media types from the updated admin interface.</p>
</div>
