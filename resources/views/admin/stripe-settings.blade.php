...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">Stripe settings</h5>
  <h2 class="mb-1">Stripe gateway</h2>
  <p class="text-muted mb-0">Manage Stripe keys and webhooks from the redesigned admin shell.</p>
</div>
@endif
