...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.countries_states') }}</h5>
  <h2 class="mb-1">Edit country</h2>
  <p class="text-muted mb-0">Update an existing country entry from the redesigned admin shell.</p>
</div>
@endif
