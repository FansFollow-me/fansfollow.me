...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.withdrawals') }}</h5>
  <h2 class="mb-1">Payout requests</h2>
  <p class="text-muted mb-0">Track creator withdrawal requests from the redesigned admin shell.</p>
</div>
@endif
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('general.withdrawals') }}</h5>
  <h2 class="mb-1">{{ __('general.withdrawals') }} ({{$data->total()}})</h2>
  <p class="text-muted mb-0">Track payout requests, payment states, and admin actions in the updated backend interface.</p>
</div>
