...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.dashboard') }}</h5>
  <h2 class="mb-1">Earnings chart</h2>
  <p class="text-muted mb-0">Review revenue trends from the redesigned admin dashboard.</p>
</div>
@endif
