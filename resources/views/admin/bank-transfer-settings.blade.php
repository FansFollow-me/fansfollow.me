...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">Bank transfer</h5>
  <h2 class="mb-1">Manual transfer settings</h2>
  <p class="text-muted mb-0">Configure bank transfer payout instructions from the redesigned admin shell.</p>
</div>
@endif
		...
		@endif
          ...
          <!-- Start Box Body -->
           <div class="box-body">
            ...
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-2 control-label">{{ __('general.bank_details') }}</label>
                <div class="col-sm-10">
                  <textarea name="bank_info" rows="7" id="description" class="form-control" placeholder="{{ __('general.bank_details') }}">{{$data->bank_info}}</textarea>
                </div>
              </div>
            </div><!-- /.box-body -->
