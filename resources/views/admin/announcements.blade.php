...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('general.announcements') }}</h5>
  <h2 class="mb-1">{{ __('general.announcement_content') }}</h2>
  <p class="text-muted mb-0">Broadcast platform-wide notices to users and creators from the updated admin workflow.</p>
</div>
@endif
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('general.announcements') }}</h5>
