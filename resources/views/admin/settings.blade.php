...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('admin.general_settings') }}</h5>
  <h2 class="mb-1">{{ trans('admin.name_site') }}</h2>
  <p class="text-muted mb-0">Update the public-facing brand, safety controls, and creator platform defaults from the redesigned admin shell.</p>
</div>
@endif
