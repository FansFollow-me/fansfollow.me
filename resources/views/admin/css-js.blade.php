...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">Custom CSS and JS</h5>
  <h2 class="mb-1">Theme overrides</h2>
  <p class="text-muted mb-0">Manage site-wide custom code injections from the redesigned admin shell.</p>
</div>
@endif
