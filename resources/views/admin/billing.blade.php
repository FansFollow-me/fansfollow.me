...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ __('general.billing_information') }}</h5>
  <h2 class="mb-1">Billing details</h2>
  <p class="text-muted mb-0">Edit invoice and company information from the redesigned admin shell.</p>
</div>
@endif
