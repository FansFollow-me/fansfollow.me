...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">Stories settings</h5>
  <h2 class="mb-1">Story content controls</h2>
  <p class="text-muted mb-0">Tune story publishing behavior from the redesigned admin shell.</p>
</div>
@endif
