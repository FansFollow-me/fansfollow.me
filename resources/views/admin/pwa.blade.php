...
@if ($isStagingDesign)
<div class="mb-4">
  <h5 class="mb-1 text-uppercase text-muted fw-semibold">Progressive Web Apps (PWA)</h5>
  <h2 class="mb-1">{{ __('general.pwa_short_name') }}</h2>
  <p class="text-muted mb-0">Configure installable app assets and PWA behavior from the redesigned admin shell.</p>
</div>
@endif
