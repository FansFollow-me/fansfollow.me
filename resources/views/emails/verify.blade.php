                            ...
                            <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0;" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                        <!-- Greeting -->
                                        <p style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                                        	{{trans('emails.verify_email_msg')}}     {{$settings->title}}
                                        	{{trans('emails.verify_email_msg_1')}}
                                        	
                                        </p>

                                        <!-- Intro -->
                        <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                          <a href="{{url('verify/account', $confirmation_code).$isProfile}}">{{trans('emails.click_here')}}</a> 
                          </p>
                           <p style="margin-top: 0;">
                            {{url('verify/account', $confirmation_code).$isProfile}}
                          </p>
                            <p style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                                        	{{trans('emails.verify_email_msg_3')}}     {{$settings->title}},
                                        	{{trans('emails.verify_email_msg_4')}}
                                        	
                                        </p>
                          <p style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                                        	{{trans('emails.verify_email_msg_5')}}     {{$settings->title}},
                                        	{{trans('emails.verify_email_msg_6')}}
                          ...
                          <!-- Salutation -->
                          <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                            {{trans('emails.regards')}},<br>The {{$settings->title}} Team <br>
