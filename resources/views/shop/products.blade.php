            ...
            <div class="btn-block mb-3 text-right">
              <span>
                <select class="ml-2 custom-select mb-2 mb-lg-0 w-auto" id="filter">
                    ...
                    <!--My Changes -->
                    <!--<option @if (request()->get('sort') == 'garments') selected @endif value="{{url('shop?sort=garments')}}">{{trans('my_lang.garments')}}</option>-->
                    <option @if (request()->get('sort') == 'video') selected @endif value="{{url('shop?sort=video')}}">{{trans('my_lang.video_calls')}}</option>
                    <option @if (request()->get('sort') == 'snapchat') selected @endif value="{{url('shop?sort=snapchat')}}">{{trans('my_lang.snapchat')}}</option>
                  </select>
