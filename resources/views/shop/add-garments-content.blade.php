...
@section('title') {{ __('my_lang.sell_garments_content') }} -@endsection
      ...
      <div class="row justify-content-center text-center mb-sm">
        <div class="col-lg-12 py-5">
          <h2 class="mb-0 font-montserrat">
            {{ __('my_lang.sell_garments_content') }}
          </h2>
          <p class="lead text-muted mt-0">
            {{ __('my_lang.custom_garments_desc') }}
        </p>
        </div>
      </div>
        ...
        <div class="col-lg-7">
            <form action="{{ url()->current() }}" method="post" enctype="multipart/form-data" id="shopProductForm">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <!--My Changes -->
                  <input type="text" class="form-control" name="tags" data-role="tagsinput" placeholder="{{ __('my_lang.tag_pre_text') }}">
                </div>
