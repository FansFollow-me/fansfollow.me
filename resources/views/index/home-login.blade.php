...
@section('content')
  @php($isStagingAuth = request()->server('FANSFOLLOW_STAGE') === 'staging_new')
  @php($authBase = $isStagingAuth ? '/auth' : '')
    ...
    <div class="container pt-lg-md">
      <div class="row">
        ...
        @if (session('login_required'))
          ...
          @if (! $settings->disable_login_register_email)
              <form method="POST" action="{{ url('login') }}" data-url-login="{{ url('login') }}" data-url-register="{{ url('signup') }}" id="formLoginRegister" enctype="multipart/form-data">
                  @csrf
                ...
                <small class="form-text text-muted">
                  <a href="{{ $authBase }}/password/reset" id="forgotPassword">
