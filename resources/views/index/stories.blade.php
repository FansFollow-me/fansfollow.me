    ...
    <div class="container container-lg-3 pt-5">
      <div class="row">
        ...
        <div class="d-lg-flex d-block justify-content-between align-items-center px-lg-0 px-4 mb-3 text-word-break">
            ...
            <!-- form -->
            <form class="position-relative mr-3 w-100 mb-lg-0 mb-2" role="search" autocomplete="off" action="{{ request()->is('app*') ? '/app/explore' : url('explore') }}" method="get" class="position-relative">
