...
@if ($isStagingDesign)
<div class="mb-4">
  <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('general.likes') }}</p>
  <h2 class="mb-1">{{ trans('general.no_likes') }}</h2>
  <p class="text-muted mb-0">Review liked content and jump back into the creators you follow most often.</p>
</div>
@endif
