...
@if ($isStagingDesign)
<div class="mb-4">
  <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('general.my_cards') }}</p>
  <h2 class="mb-1">{{ trans('general.info_my_cards') }}</h2>
  <p class="text-muted mb-0">Manage saved payment cards and billing methods from the redesigned creator workspace.</p>
</div>
@endif
