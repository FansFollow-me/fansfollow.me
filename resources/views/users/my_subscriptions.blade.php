...
<section class="section section-sm">
    <div class="container">
      @if ($isStagingDesign)
      <div class="mb-4">
        <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('users.my_subscriptions') }}</p>
        <h2 class="mb-1">{{ trans('users.my_subscriptions_subtitle') }}</h2>
        <p class="text-muted mb-0">Keep an eye on active subscriptions, expirations, and direct creator messages.</p>
      </div>
      @endif
                  ...
                  <tr>
                    <td>
                      ...
                      <a href="{{url($subscription->subscribed()->username)}}">
                        ...
                        <!--My changes -->
                          <a href="{{url('messages/'.$subscription->subscribed()->id, $subscription->subscribed()->username)}}" title="{{trans('general.message')}}">
