...
@if ($isStagingDesign)
  <div class="container py-3">
    <div class="mb-4">
      <h5 class="mb-1 text-uppercase text-muted fw-semibold">{{ trans('general.invoice') }}</h5>
      <h2 class="mb-1">Creator invoice</h2>
      <p class="text-muted mb-0">Review a payment invoice from the redesigned creator and finance shell.</p>
    </div>
  </div>
@endif
  <!-- Main content -->
