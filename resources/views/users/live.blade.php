    ...
    <div class="container">
      <div class="row justify-content-center text-center mb-sm">
        <div class="col-lg-12 py-5">
          <h2 class="mb-0 font-montserrat"><i class="bi bi-broadcast mr-2"></i> {{trans('general.live_streaming')}}</h2>
          <p class="lead text-muted mt-0">Monitor live rooms and start streams from the redesigned creator broadcast shell.</p>
        </div>
      </div>
    </div>
  </section>
