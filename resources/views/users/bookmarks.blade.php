...
@if ($isStagingDesign)
<div class="mb-4">
  <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('general.bookmarks') }}</p>
  <h2 class="mb-1">{{ trans('general.no_bookmarks') }}</h2>
  <p class="text-muted mb-0">Keep saved posts, creator updates, and quick returns in one place.</p>
</div>
@endif
