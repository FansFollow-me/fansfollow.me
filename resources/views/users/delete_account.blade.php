...
@if ($isStagingDesign)
<div class="mb-4">
  <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('general.delete_account') }}</p>
  <h2 class="mb-1">{{ trans('general.subtitle_delete_account') }}</h2>
  <p class="text-muted mb-0">Handle account closure from the same security-focused creator settings view.</p>
</div>
@endif
