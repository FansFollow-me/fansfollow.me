...
@if ($isStagingDesign)
<div class="mb-4">
  <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('users.my_subscribers') }}</p>
  <h2 class="mb-1">{{ trans('users.my_subscribers_subtitle') }}</h2>
  <p class="text-muted mb-0">Review subscriber growth, active access, and recent joins without leaving the dashboard.</p>
</div>
@endif
