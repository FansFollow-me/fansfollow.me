    ...
    <div class="container">
      <div class="row justify-content-center text-center mb-sm">
        <div class="col-lg-12 py-5">
          <h2 class="mb-0 font-montserrat"><i class="bi bi-bag-x mr-2"></i> {{trans('general.not_purchased_any_content')}}</h2>
          <p class="lead text-muted mt-0">Review purchased creator content from the redesigned marketplace activity view.</p>
        </div>
      </div>
    </div>
  </section>
