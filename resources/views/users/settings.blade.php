...
<section class="section section-sm">
    <div class="container">
      @if ($isStagingDesign)
      <div class="mb-4">
        <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('users.settings') }}</p>
        <h2 class="mb-1">{{ trans('users.settings_desc') }}</h2>
        <p class="text-muted mb-0">Update the account, privacy, payouts, and creator tools from one place.</p>
      </div>
      @endif
