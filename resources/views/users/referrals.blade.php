...
@if ($isStagingDesign)
<div class="mb-4">
  <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('general.referrals') }}</p>
  <h2 class="mb-1">{{ trans('general.your_referral_link') }}</h2>
  <p class="text-muted mb-0">Track referrals, link sharing, and commission progress from the creator dashboard.</p>
</div>
@endif
