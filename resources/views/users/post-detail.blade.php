    ...
    <div class="container">
      <div class="row justify-content-center text-center mb-sm">
        <div class="col-lg-12 py-5">
          <h2 class="mb-0 font-montserrat">{{ trans('general.by') }} {{ $user->hide_name == 'yes' ? '@'.$user->username : $user->name }}</h2>
          <p class="lead text-muted mt-0">View a creator post inside the redesigned profile detail layout.</p>
        </div>
      </div>
    </div>
  </section>
