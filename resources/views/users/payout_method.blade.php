...
<section class="section section-sm">
    <div class="container">
      @if ($isStagingDesign)
      <div class="mb-4">
        <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ __('users.payout_method') }}</p>
        <h2 class="mb-1">{{ trans('general.default_payout_method') }}</h2>
        <p class="text-muted mb-0">Choose where withdrawals are sent and keep the payout profile current.</p>
      </div>
      @endif
