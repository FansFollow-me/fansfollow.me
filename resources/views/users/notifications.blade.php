...
<div class="mb-4">
  <div class="d-flex flex-column flex-lg-row align-items-lg-end justify-content-between gap-3">
    <div>
      <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('general.notifications') }}</p>
      <h2 class="mb-1">{{ trans('general.notifications_subtitle') }}</h2>
      <p class="text-muted mb-0">Keep up with account alerts, message activity, and payout updates in one place.</p>
    </div>
  </div>
</div>
@endif
      ...
      <div class="row">
        ...
        <?php
            ...
            $notyNormal = true;
              ...
              case 5:
        				$action          = trans('general.he_sent_you_tip').' '.Helper::amountFormatDecimal($key->tip_amount);     /*My Changes*/
            ...
            case 6:
              ...
              case 16:
                ...
                break;
                /*My Changes */ case 20:
        				$action          = trans('my_lang.video_processed_successfully_shop');
        		...
        		break;
        		/*My Changes */ case 18:
        				$action          = trans('my_lang.like_you_shop');
						$linkDestination = url('shop/product', $key->target);
						$text_link       = Str::limit($key->productName, 50, '...');
        		break;
        		/*My Changes */ case 19:
        				$action          = trans('my_lang.comment_you_shop');
						$linkDestination = url('shop/product', $key->target);
						$text_link       = Str::limit($key->productName, 50, '...');
        		break;
        		}
            ...
            @endif
              ...
              @endif
                ...
                @if ($linkDestination != false)
                  <a href="{{url($linkDestination)}}">{!! strip_tags($text_link) !!}</a> <!--My changes-->
                @endif
              </h6>
