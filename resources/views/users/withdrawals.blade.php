...
<section class="section section-sm">
    <div class="container">
      @if ($isStagingDesign)
      <div class="mb-4">
        <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('general.withdrawals') }}</p>
        <h2 class="mb-1">{{ trans('general.history_withdrawals') }}</h2>
        <p class="text-muted mb-0">Track payout requests, balances, and processing windows without leaving the creator area.</p>
      </div>
      @endif
