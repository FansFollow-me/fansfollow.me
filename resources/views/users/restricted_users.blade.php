...
@if ($isStagingDesign)
<div class="mb-4">
  <p class="text-uppercase text-muted mb-2 small font-weight-bold">{{ trans('general.restricted_users') }}</p>
  <h2 class="mb-1">{{ trans('general.info_restricted_users') }}</h2>
  <p class="text-muted mb-0">Review blocked accounts and remove restrictions from the same creator management shell.</p>
</div>
@endif
