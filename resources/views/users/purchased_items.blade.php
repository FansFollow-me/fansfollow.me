    ...
    <div class="container">
      <div class="row justify-content-center text-center mb-sm">
        <div class="col-lg-12 py-5">
          <h2 class="mb-0 font-montserrat"><i class="bi bi-bag-check mr-2"></i> Purchased items</h2>
          <p class="lead text-muted mt-0">Review purchased creator items from the redesigned shopping activity view.</p>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="table-responsive">
            <table class="table table-striped m-0">
              ...
              <tbody>
                ...
                @if($purchase->products()) <!--My Changes-->
                  <tr>
                    <td>
